...
Then for any tree $[p_1,x_1x_2x_3(p_2,x_4)]$ or $[p_1,x_1x_2(p_2,x_3x_4)]$ (see the diagram) there is a pivotal tree satisfying the tree comparison.
...
\begin{tikzpicture}[scale=1,
  ...
  \node[main node] (4) at (1,0) {$x_3$};
  \node[main node] (5) at (1,1) {$p_2$};
  \node[main node] (6) at (1,2) {$x_4$};
...
\begin{tikzpicture}[scale=1,
  ...
  \node[main node] (1) at (0,1) {$x_2$};
  \node[main node] (2) at (1,0){$x_1$};
  \node[main node] (3) at (1,1){$p_1$};
  \node[main node] (4) at (1,2) {$x_3$};
  \node[main node] (5) at (2,0) {$x_4$};
  \node[main node] (6) at (2,1) {$p_2$};
