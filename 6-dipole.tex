...
Indeed, if $\~\xi_1$ is a vertex of degree 1 that is adjacent to $\~\xi_2$, then $\alpha_{1,2}>\pi$ which contradicts \ref{cor:|x-x|}\textit{\ref{cor:|x-x|:a}};
if $\~\xi_1$ is a vertex of degree 0 then all other vertexes have degree 2 and therefore $\alpha_{2,3}+\alpha_{2,4}+\alpha_{3,4}>2\cdot \pi$ which contradicts \ref{cor:|x-x|}\textit{\ref{cor:|x-x|:b}}. 
