...
moreover, if one of the conditions holds in a CTIL Riemannian manifold $M$ that satisfies one of the conditions (\ref{thm:convexity:convexity}) or (\ref{thm:convexity:MTW}), then $M$ satisfies all bipolar comparisons; that is, the $m(n)$-tree comparison holds for any $m$ and $n$.
\end{thm}
