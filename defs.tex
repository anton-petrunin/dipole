...
It is straightforward to modify the proof of Theorem~\ref{thm:convexity} to get the following description of the MTW condition.
This proposition could be considered as an more intuitive version of Proposition 2.6 in \cite{MTW+CTIL} from which it follows easily.
...
\[h(v)=\tfrac12\cdot(|v|^2-\dist_q^2\circ\exp_p(v))\] 
has convex sublevel sets; that is, the set
