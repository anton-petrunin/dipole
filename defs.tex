...
In Section~\ref{6-dipole} we will show that the comparison for the any Alexandrov space with nonnegative curvature satisfies the tree comparisons for the first two trees an the following diagram.
...
In Section~\ref{7-dipole}, we will show that the comparison for the third tree on the diagram implies
