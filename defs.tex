...
For example, the $(2n+2)$-comparison described in \cite{AKP} can be considered as a $(\pm)$-colored graph comparison for the following graph, where $(-)$-edges are marked by solid lines and $(+)$-edges by dashed lines.
