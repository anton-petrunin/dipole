...
The condition (\textit{\ref{thm:convexity:MTW}}) in the theorem is stronger since it does not require orthogonality.\footnote{Likely the condition (\textit{\ref{thm:convexity:MTW}}) is strictly stronger, but it is not known; also it is not known if MTW implies CTIL \cite{MTW+CTIL+}.}
