...
In fact our proof works for all complete length spaces but it requires extra technical work in Alexandrov geometry, which we are trying to keep at minimum.. 
...
The comparison for monopolar trees has an algebraic corollary which was used Urs Lang and Viktor Schroeder in \cite{LS}. 
