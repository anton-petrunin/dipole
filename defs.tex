...
concavity of the function $h=f-s$.
In the following theorem we give a description of the MTW condition via convexity of suplevel set of $h$.
Its proof is a straightforward modification the proof of Theorem~\ref{thm:convexity};
this proposition could be considered as an more intuitive version of Proposition 2.6 in \cite{MTW+CTIL} from which it follows easily by an iteration.
