...
Essential part of this work was done during the intense activity period ``Metric Measure Spaces and Ricci Curvature'' September 4--29, 2017 in Bonn.}
...
\begin{abstract}
We define a new type of metric comparison similar to the comparison of Alexandrov.
...
\bibitem{AKP} Alexander, S.; Kapovitch, V.; Petrunin,  A.,
...
\bibitem{lebedeva} Lebedeva, N.,  \emph{On open flat sets in spaces with bipolar comparison.} \texttt{arXiv:1807.02708 [math.DG]}.
...
\bibitem{petunin-mof} Petrunin, A., \emph{Conjugate points on cut locus,} \texttt{mathoverflow.net/q/260032}.

\bibitem{petrunin} Petrunin, A., \emph{In search of a five-point Aleksandrov type condition.} St. Petersburg Math. J. 29 (2018), no. 1, 223--225.
