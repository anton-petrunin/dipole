...
\parbf{On tree comparisons for length spaces.}
...
It is straightforward to generalize Theorem~\ref{thm:3(1)+2(2)} to  Alexandrov spaces; that is \emph{any nonnegatively curved Alexandrov space satisfies 3(1) or 2(2)-tree comparison}.
...
For big branchy trees, the properties of spaces with the tree comparison should remind more the quotients of Hilbert space. 