...
For example, as we mentioned, MTW$^{\not\perp}$ is stronger than MTW, but we fail to show that it is strictly stronger. In other words, is there a (CTIL) Riemannian manifold which is MTW, but not MTW$^{\not\perp}$? 
An other example: it might happen that 3(3)-tree comparison is equivalent to MTW+CTIL which would provide a synthetic description of these conditions.
