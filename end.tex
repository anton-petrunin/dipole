...
It is straightforward to generalize Theorem~\ref{thm:3(1)+2(2)} to  Alexandrov spaces; that is, \emph{a complete length space $L$ satisfies  3(1) or 2(2)-tree comparison if and only if $L$ is a nonnegatively curved Alexandrov space}.
